 ...
 Info("                                                                            ");
 Info("  ECI GRWPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_GET_REPLY_WAIT                             ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - GRWPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - GRWPC001" ) ;
 ...
 void Make_One_Call_Set(HWND hwnd)
   {
     ...
     /************************************************************************/
     /* Now make a ECI_GET_REPLY_WAIT call to receive commarea when ready   */
     /************************************************************************/
     Info("ออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออ");
     Info("Calling      : ECI_GET_REPLY_WAIT");
     /************************************************************************/
