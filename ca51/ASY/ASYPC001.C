 ...
 Info("                                                                            ");
 Info("  ECI ASYPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_ASYNC                                      ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - ASYPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - ASYPC001" ) ;
