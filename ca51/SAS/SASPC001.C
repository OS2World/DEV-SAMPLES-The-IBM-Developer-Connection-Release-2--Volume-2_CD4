 ...
 /*                                                                   */
 /*  Code Origin : Based upon ECI SASple code by D.Smith              */
 /*                                                                   */
 ...
 Info("                                                                            ");
 Info("  ECI SASPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_STATE_ASYNC                                ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - SASPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - SASPC001" ) ;
 ...
 void Make_One_Call_Set(HWND hwnd)
   {
    ...
    if (ECIRetCode!=ECI_NO_ERROR) 
      {
        Info("Called       : ECI_GET_REPLY_WAIT");
        Process_Return_Code(ECIRetCode, hwnd);
      }
    else
      {
