 ...
 Info("                                                                            ");
 Info("  ECI GRSPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_GET_SPECIFIC_REPLY                         ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - GRSPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - GRSPC001" ) ;
 ...
 void Make_One_Call_Set(HWND hwnd)
   {
     ...
     /*********************************************************************/
     EciBlock.eci_version = ECI_VERSION_1;
     EciBlock.eci_call_type = ECI_ASYNC_NOTIFY_MSG;
     ...
     EciBlock.eci_async_notify.window_handle = hwnd ;
     EciBlock.eci_message_id = WM_USER + 1 ;
     /*********************************************************************/
     /* Call the ECI:                                                    */
     /*********************************************************************/
     EciBlock.eci_message_qualifier = 42;
     Info("Calling      : ECI_ASYNC_NOTIFY_MSG");
                                   ...
                                   MPARAM mp2 )
 {
    ...
    case WM_USER + 1 :
      ...
      /************************************************************************/
      sprintf ( szBuffer, "ECI has returned. Perform GET_SPECIFIC_REPLY" ) ;
      Info(szBuffer);
      Info("Calling      : ECI_GET_SPECIFIC_REPLY");
      /************************************************************************/
