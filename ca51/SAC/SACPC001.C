 ...
 Info("                                                                            ");
 Info("  ECI SACPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_STATE_ASYNC with CALLBACK notification     ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - SACPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - SACPC001" ) ;
    ...
    if (ECIRetCode!=ECI_NO_ERROR) 
      {
        ...
        Info("Called       : ECI_STATE_ASYNC with callback notification");
