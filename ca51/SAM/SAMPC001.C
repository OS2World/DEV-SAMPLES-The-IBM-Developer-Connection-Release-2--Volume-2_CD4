 ...
 Info("                                                                            ");
 Info("  ECI SAMPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_STATE_ASYNC_MSG                            ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - SAMPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - SAMPC001" ) ;
 ...
 void Make_One_Call_Set(HWND hwnd)
   {
    ...
    EciBlock.eci_call_type = ECI_STATE_ASYNC_MSG; /* set call type */
    ...
    if (ECIRetCode!=ECI_NO_ERROR) 
      {
        ...
        Info("Called       : ECI_STATE_ASYNC_MSG");
