 ...
 Info("                                                                            ");
 Info("  ECI ANMPC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_ASYNC_NOTIFY_MSG                           ");
 Info("                                                                            ");
   ...
   char *envp[];
 {
    ...
    hwndFrame = WinCreateStdWindow ( HWND_DESKTOP,
                                     ...
                                     &flCreate,
                                     WC_LISTBOX,
                                     "CICS Client Test - ANMPC001 (A.Thomson 94)",
                                     LS_HORZSCROLL,
                                     0,
                                     ID_MAINWND,
                                     ( PHWND ) &hwndClient ) ;
    ...
    sprintf ( swctl.szSwtitle, "CICS Client Test - ANMPC001" ) ;
                                   ...
                                   MPARAM mp2 )
 {
    ...
    switch ( msg ) {
    case WM_CREATE:
       if (Unattended) WinPostMsg(hwndFrame, WM_COMMAND, (MPARAM)ID_CALL_ECI, 0L);
       break;
    case WM_COMMAND:
    ...
    case ECI_MSG:
       ...
       /************************************************************************/
       sprintf ( szBuffer, "ECI has returned. Perform GET_REPLY" ) ;
       Info(szBuffer);
