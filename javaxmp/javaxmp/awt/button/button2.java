...
public class button2 extends Applet
{
  ...
  public void init()
  {
    ...
    //--------------------------------------------------------------
    // Notice how each component has a name associated with it of
    // the form "compname" + "number". For example, the first 
    // button that you create will be named "button1" and the second
    // will be named "button2" etc.
    //--------------------------------------------------------------
    System.out.println( yes.getName() ) ;
    System.out.println( no.getName() ) ;
    System.out.println( maybe.getName() ) ;
  }
