...
// OneCell.java
//
// A simple test program to test the LEDCell class.
// 
//
...
// Class: OneCell
//
// Simple class that experiments with the LEDCell 
//
//---------------------------------------------------------------

public class OneCell extends Frame implements ActionListener
{
  Panel  keypad ;
  ...
  public OneCell( String s )
  {
    ...
    keypad = new Panel();
    keypad.setLayout( new GridLayout( 5,2 ) ) ;
  ...
  public void actionPerformed( ActionEvent aevt )
  {
    ...
    cell.setValue( (Integer.valueOf(aevt.getActionCommand()).intValue() )) ;
  }
  ...
  {
     OneCell OneCellFrame ;

     OneCellFrame = new OneCell( "Cell" ) ;

     OneCellFrame.setSize( 100,400 ) ;
     OneCellFrame.show() ;
  }
}
