//------------------------------------------------------------------------
// File Name:     LayoutMultiBorder
// Description:   A layout manager like BorderLayout, except that it
//                allows multiple objects on its borders. 
//
// Modification History
// Date   Developer Defect  Tag         Description
// ------ --------- ------- ----------- ----------------------------------
// 042197 DOBecker                      Created.
//------------------------------------------------------------------------
package common;
 ...
 *
 * @author Dan Becker - becker@vnet.ibm.com
 * @version 04/21/97
 */
public class LayoutMultiBorder implements LayoutManager, Cloneable {
   // Public contants
   public static int BEGINSIZE = 4;
   public static int GROWTHSIZE = 4;

   // Constructors
   /**
    * Constructs an LayoutMultiBorder
    */
   public LayoutMultiBorder() {
      ...
      north = new Vector( BEGINSIZE, GROWTHSIZE );
      south = new Vector( BEGINSIZE, GROWTHSIZE );
      east =  new Vector( BEGINSIZE, GROWTHSIZE );
      west =  new Vector( BEGINSIZE, GROWTHSIZE );
   }
