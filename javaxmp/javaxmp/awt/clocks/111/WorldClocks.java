...
//
// History:
//  16-Apr-1997 -KRL- Created Java 1.1 dependant version that uses TimeZone class.
//  21-Oct-1997 -KRL- Synched up with fixes made to 1.0.2 version.
//  21-Oct-1997 -KRL- Ported Java 1.0.2 version to 1.1 event model.
//  21-Oct-1997 -KRL- Ported to the new Timer/SimpleTime classes.
//  21-Oct-1997 -KRL- Replaced old clock display with LEDClockPanel classes.
//
//--------------------------------------------------------------------------------
...
//
//---------------------------------------------------------------
public class WorldClocks extends Applet implements SimpleTimer
{
  ...
  //-------------------------------------------------------------------------
  static final boolean summerTimeUK = true ;
  ...
  public void init()
  {
    ...
    clocks    = new LEDClockPanel[NUM_CLOCKS] ;
