...
public class IsvappsDataIdManagerBeanInfo extends SimpleBeanInfo
{
  public IsvappsDataIdManagerBeanInfo() {
    if (!flag) {
      addProperties();
      addMethods();
      initBeanDescriptor();
  ...
  private static void addProperties() {
    try {
      _pDesc[0] = new PropertyDescriptor("element", IsvappsDataIdManager.class, "element", null );
  ...
  private static void addMethods() {
    ...
    try {
      ...
      _mDesc[0] = new MethodDescriptor(IsvappsDataIdManager.class.getMethod("element", null), null);
  ...
  public java.awt.Image getIcon(int iconKind) {
    if (iconKind == BeanInfo.ICON_COLOR_16x16) {
      java.awt.Image img = loadImage("DataIdManagerColor16.gif");
      return img;
    }
    if (iconKind == BeanInfo.ICON_COLOR_32x32) {
      java.awt.Image img = loadImage("DataIdManagerColor32.gif");
      return img;
    }
    if (iconKind == BeanInfo.ICON_MONO_16x16) {
      java.awt.Image img = loadImage("DataIdManagerMono16.gif");
      return img;
    }
    if (iconKind == BeanInfo.ICON_MONO_32x32) {
      java.awt.Image img = loadImage("DataIdManagerMono32.gif");
      return img;
    }
    return null;
  }
  ...
  public static String getGifFile () {
    return "DataIdManager.gif";
  }

  public BeanDescriptor getBeanDescriptor() { return _descriptor; }

  private static void initBeanDescriptor() {
    _descriptor.setShortDescription("Manager class for IsvappsDataId objects.");
  }

  private static BeanDescriptor _descriptor = new BeanDescriptor(IsvappsDataIdManager.class);
