 ...
 printf("บ                                                                           บ\n");
 printf("บ ECI SAEOC003 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
 printf("บ                                                                           บ\n");
 printf("บ C Program making call type ECI_STATE_ASYNC_SEM (with Event semaphore)     บ\n");
 printf("บ                                                                           บ\n");
 ...
 void Make_One_Call_Set()
   {
    ...
    EciBlock.eci_extend_mode  = ECI_STATE_IMMEDIATE; /* set call mode */
 ...
 int main(argc, argv, envp)
   ...
   char *envp[];
   {
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI SAEOC003 - Original Coding by A.Thomson Summer 94 \n"); 
    ...
    printf("--------------------------------------------------------\n"); 
    printf(" ECI SAEOC003 - Application Termination\n"); 
    printf("--------------------------------------------------------\n"); 
