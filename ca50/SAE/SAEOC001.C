 ...
 void SayHelp( void )
 {
    ...
    printf("บ                                                                           บ\n");
    printf("บ ECI SAEOC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
    printf("บ                                                                           บ\n");
 ...
 void Make_One_Call_Set()
   {
    ...
    EciBlock.eci_async_notify.sem_handle = &semEci ; /* Semaphore     */
    ...
    if (ECIRetCode==ECI_NO_ERROR) 
      {
       ...
       DosSemWait( &semEci, SEM_INDEFINITE_WAIT ); 
       ...
       if (ECIRetCode==ECI_NO_ERROR)
         {
           ...
           switch (EciStatus.CicsClientStatus)
            {
             case 0 : printf("  CicsClientStatus : ECI_CLIENTSTATE_UNKNOWN     \n"); break;
 ...
 int main(argc, argv, envp)
    ...
    char *envp[];
   {
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI SAEOC001 - Original Coding by A.Thomson Summer 94 \n"); 
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI SAEOC001 - Application Termination\n"); 
     printf("--------------------------------------------------------\n"); 
