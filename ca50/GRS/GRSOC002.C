 ...
 printf("บ                                                                           บ\n");
 printf("บ ECI GRWOC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
 printf("บ                                                                           บ\n");
 printf("บ Input Parameter Help;                                                     บ\n");
 printf("บ                                                                           บ\n");
 printf("บ C program making call type ECI_GET_SPECIFIC_REPLY_WAIT                    บ\n");
 printf("บ                                                                           บ\n");
 ...
 void Make_One_Call_Set()
   {
     ...
     EciBlock.eci_call_type = ECI_ASYNC;          /* Async                 */
     ...
     EciBlock.eci_message_qualifier = 52;
     ...
     if ( ECIRetCode != ECI_NO_ERROR )
     ...
     else
       {
        ...
        printf("\n"); 
        printf("  Follow on call : ECI_GET_SPECIFIC_REPLY_WAIT\n"); 
        ECIRetCode = CICS_ExternalCall ( &EciBlock ) ;
 ...
 int main(argc, argv, envp)
   ...
   char *envp[];
   {
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI GRWOC001 - Original Coding by A.Thomson Summer 94 \n"); 
    ...
    printf("--------------------------------------------------------\n"); 
    printf(" ECI GRWOC001 - Application Termination\n"); 
    printf("--------------------------------------------------------\n"); 
