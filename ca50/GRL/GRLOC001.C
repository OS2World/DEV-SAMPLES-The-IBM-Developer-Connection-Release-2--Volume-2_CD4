 ...
 printf("บ                                                                           บ\n");
 printf("บ ECI GRLOC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
 printf("บ                                                                           บ\n");
 printf("บ Input Parameter Help;                                                     บ\n");
 printf("บ                                                                           บ\n");
 printf("บ C program making call type ECI_GET_REPLY                                  บ\n");
 printf("บ                                                                           บ\n");
 ...
 int main(argc, argv, envp)
   ...
   char *envp[];
   {
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI GRLOC001 - Original Coding by A.Thomson Summer 94 \n"); 
    ...
    printf("--------------------------------------------------------\n"); 
    printf(" ECI GRLOC001 - Application Termination\n"); 
    printf("--------------------------------------------------------\n"); 
