    ...
    while ( j < argc )  {
       if ( strchr ( "/-(", argv[j][0] ) ) { /* looks like an option  */
          ...
          case 'D' :                         /* /D:Delay              */
             ...
             break;
          case 'B' :                         /* /B                    */
             strncpy( EciBlock.eci_system_name, "        ",8);
             strncpy( EciBlock.eci_userid,      "        ",8);
             strncpy( EciBlock.eci_password,    "        ",8);
             printf("System Name, userid & password filled with blanks!\n");
             break;
          case 'S' :                         /* /S:Server             */
 ...
 printf("บ                                                                           บ\n");
 printf("บ ECI SYNOC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
 printf("บ                                                                           บ\n");
 printf("บ C program making call type ECI_SYNC                                       บ\n");
 printf("บ                                                                           บ\n");
 ...
 printf("บ                                                                           บ\n");
 printf("บ /B              Fill System Name, Userid & Password fields with Blanks!   บ\n");
 printf("บ                                                                           บ\n");
