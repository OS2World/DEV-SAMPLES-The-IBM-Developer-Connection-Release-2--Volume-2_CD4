 ...
 printf("บ                                                                           บ\n");
 printf("บ ECI ANEOC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
 printf("บ                                                                           บ\n");
 printf("บ C program making call type ECI_ASYNC_NOTIFY_SEM (with RAM semaphore)      บ\n");
 printf("บ                                                                           บ\n");
 ...
 void Make_One_Call_Set()
   {
     cics_sshort_t ECIRetCode;
     int SEMRetCode;
     ULONG semEci;       /* Semaphore to wait on                */

     printf(" ------------------------------------------------------ \n"); 

     SEMRetCode = DosSemSet ( &semEci ) ;
     if ( SEMRetCode != 0 )
       {
     ...
     EciBlock.eci_async_notify.sem_handle = &semEci ; /* Semaphore for     */
     ...
     if (EciBlock.eci_system_name[0] != 0 )
     ...
     if ( ECIRetCode != ECI_NO_ERROR )
     ...
     else
       {
        ...
        /************************************************************************/
        printf("\n"); 
        printf ( "  Wait on RAM Semaphore before calling for reply\n" ) ;
        /************************************************************************/
        ...
        /************************************************************************/
        DosSemWait( &semEci, SEM_INDEFINITE_WAIT ) ;  /* Wait indefinitely */
 ...
 int main(argc, argv, envp)
   ...
   char *envp[];
   {
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI ANEOC001 - Original Coding by A.Thomson Summer 94 \n"); 
    ...
    printf("--------------------------------------------------------\n"); 
    printf(" ECI ANEOC001 - Application Termination\n"); 
    printf("--------------------------------------------------------\n"); 
