 ...
 printf("บ                                                                           บ\n");
 printf("บ ECI ANEOC002 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       บ\n");
 printf("บ                                                                           บ\n");
 printf("บ C program making call type ECI_ASYNC_NOTIFY_SEM (with System semaphore)   บ\n");
 printf("บ                                                                           บ\n");
 ...
 void Make_One_Call_Set()
   {
     ...
     EciBlock.eci_async_notify.sem_handle = hsemEci ; /* Semaphore for     */
     ...
     if ( ECIRetCode != ECI_NO_ERROR )
     ...
     else
       {
        ...
        /************************************************************************/
        printf("\n"); 
        printf ( "  Wait on System Semaphore before calling for reply\n" ) ;
        /************************************************************************/
        ...
        /************************************************************************/
        DosSemWait( hsemEci, SEM_INDEFINITE_WAIT ) ; /* Wait indefinitely */
 ...
 int main(argc, argv, envp)
   ...
   char *envp[];
   {
     ...
     printf("--------------------------------------------------------\n"); 
     printf(" ECI ANEOC002 - Original Coding by A.Thomson Summer 94 \n"); 
    ...
    printf("--------------------------------------------------------\n"); 
    printf(" ECI ANEOC002 - Application Termination\n"); 
    printf("--------------------------------------------------------\n"); 
