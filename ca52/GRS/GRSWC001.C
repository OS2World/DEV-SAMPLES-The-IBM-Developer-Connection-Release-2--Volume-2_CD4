 ...
 void Process_Return_Code(short RetCode);
 ...
 {
 Info("                                                                            ");
 Info("  ECI GRSWC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type GET_SPECIFIC_REPLY                             ");
 Info("                                                                            ");
 ...
 void Make_One_Call_Set(HWND hwnd)
   {
     ...
     /* Call the ECI:                                                    */
     /*********************************************************************/
     EciBlock.eci_message_qualifier = 43;
                      ...
                      int nCmdShow )
 {
   ...
   if ( hPrevInst == NULL ) {
    ...
    hwndFrame = CreateWindow ( ECI_CLASS,
                               "CICS Client Test - GRSWC001 (A.Thomson 94)",
                               WS_OVERLAPPEDWINDOW,
    ...
    Info(" -------------------------------------------------------------------------------- "); 
    Info(" ECI GRSWC001 - A.Thomson Summer 94 "); 
