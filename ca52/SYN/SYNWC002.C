 ...
 {
 Info("                                                                            ");
 Info("  ECI SYNWC002 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_SYNC (Extended)                            ");
 Info("                                                                            ");
                      ...
                      int nCmdShow )
 {
   ...
   if ( hPrevInst == NULL ) {
    ...
    hwndFrame = CreateWindow ( ECI_CLASS,
                               "CICS Client Test - SYNWC002 (A.Thomson 94)",
                               WS_OVERLAPPEDWINDOW,
...
//  ParseParms( argc, argv );
    ...
    Info(" -------------------------------------------------------------------------------- "); 
    Info(" ECI SYNWC002 - A.Thomson Summer 94 "); 
