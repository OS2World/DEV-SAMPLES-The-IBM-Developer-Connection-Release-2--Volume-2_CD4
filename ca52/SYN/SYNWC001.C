 ...
 {
 Info("                                                                            ");
 Info("  ECI SYNWC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type ECI_SYNC                                       ");
 Info("                                                                            ");
 ...
 void Make_One_Call_Set()
   {
     ...
     Info(" -------------------------------------------------------------------------------- "); 
     Info( "  Calling     : ECI_SYNC" );
     sprintf(szBuffer,"  Server      : %s", EciBlock.eci_system_name );
     Info(szBuffer);

     strcpy ( Name, "ECI_SYNC" ) ;
                      ...
                      int CmdShow )
 {
   ...
   if ( hPrevInst == NULL ) {
    ...
    hwndFrame = CreateWindow ( ECI_CLASS,
                               "CICS Client Test - SYNWC001 (A.Thomson 94)",
                               WS_OVERLAPPEDWINDOW,
    ...
    Info(" -------------------------------------------------------------------------------- "); 
    Info(" ECI SYNWC001 - A.Thomson Summer 94 "); 
