 ...
 {
 Info("                                                                            ");
 Info("  ECI LSTWC001 - A.Thomson Summer 94 (See CCECIDOC for Documentation)       ");
 Info("                                                                            ");
 Info("  C program making call type CICS_EciListSystems                            ");
 Info("                                                                            ");
                      ...
                      int nCmdShow )
 {
   ...
   if ( hPrevInst == NULL ) {
    ...
    hwndFrame = CreateWindow ( ECI_CLASS,
                               "CICS Client Test - LSTWC001 (A.Thomson 94)",
                               WS_OVERLAPPEDWINDOW,
    ...
    Info(" -------------------------------------------------------------------------------- "); 
    Info(" ECI LSTWC001 - A.Thomson Summer 94 "); 
 ...
 void Make_One_Call_Set()
   {
     ...
     ECIRetCode = CICS_EciListSystems(NameSpace,&Systems,List);
     ...
     if (ECIRetCode==ECI_NO_ERROR)
       {
         ...
         while( pos < Systems)
          {
            Info("");
            sprintf(szBuffer,"  System %d of %d :-", pos+1, Systems );
            Info(szBuffer);
            sprintf(szBuffer,"    SystemName = %s", List[pos].SystemName );
            Info(szBuffer);
            sprintf(szBuffer,"    Description = %s", List[pos].Description );
            Info(szBuffer);
            pos++;
          }
          sprintf(szBuffer, "");
